...
public class C_DefaultMethods {
  ...
  //
  // assertEquals(Map.of("a", "alfa", "b", "bravo", "c", "charlie", "d", "delta", "e", "", "f", "", "g", ""), map);
  // }
  // // Hint:
  // // <editor-fold defaultstate="collapsed">
  ...
  //
  // /**
  // * In the previous example, we added map entries that had a default value. We've now determined that's incorrect, and we want to undo that. This time, we want to remove the
  // entry
  ...
  // List<String> keys = Arrays.asList("a", "b", "c", "d", "e", "f", "g");
  // Map<String, String> map = new HashMap<>(Map.of("a", "alfa", "b", "bravo", "c", "charlie", "d", "delta", "e", "", "f", "", "g", ""));
  //
  // // TODO write code to fix the map
  //
  ...
  // // TODO write code to fix the map
  //
  // assertEquals(Map.of("a", "alfa", "b", "bravo", "c", "charlie", "d", "delta", "e", "e", "f", "f", "g", "g"), map);
  // }
  // // Hint:
  // // <editor-fold defaultstate="collapsed">
  ...
  //
  // /**
  // * The map now has several entries, some with valid values, and some with values that are the empty string. This time, we want to convert the non-empty values to upper case,
  // but
